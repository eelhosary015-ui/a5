...
content = content.replace('className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-between"', 'className="w-full md:w-1/2 p-5 sm:p-8 md:p-12 flex flex-col justify-between flex-1 overflow-y-auto"');
